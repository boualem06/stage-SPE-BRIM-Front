...
<nav style={{ position: 'sticky', top: '0', zIndex: '100' }} className="bg-[#3F4E6B] border-gray-200 text-white ">
  ...
  <div className="flex md:order-2">
    ...
    <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-search">
      <div className="relative mt-3 md:hidden">
        ...
        <input type="text" id="search-navbar" className="block w-full p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-red-500  focus:border-blue-500  " placeholder="Search..." />
      </div>
